...
public class VendingMachineTest {
    ...
    public void testBuyItemWithExactPrice() { // select item, price in cents
        long price = vm.selectItemAndGetPrice(Item.COKE); // price should be Coke's price
    ...
    assertEquals(Item.COKE, item); //there should not be any change
...
@Test public void testBuyItemWithMorePrice(){
    ...
    //should be Coke
    assertEquals(Item.SODA, item); //there should not be any change
    assertTrue(!change.isEmpty()); //comparing change
